...
bit_range="[2,3]"
   ...
   then
      ...
      mkdir /home/parsa_liza/experiments/sparse_results_12.09/$benchmark/quant_scheme2/$sparsity_num_format\_block\_size\_$blocksize/
      mkdir /home/parsa_liza/experiments/sparse_results_12.09/$benchmark/quant_scheme2/$sparsity_num_format\_block\_size\_$blocksize/hbfp\_$bit_range/
   fi
   ...
   python3 run_image_classification.py  \
      ...
      --output_dir /home/parsa_liza/experiments_12.09/sparse_results/$benchmark/quant_scheme2/$filename  \
      ...
      --optim BFPAdam | tee /home/parsa_liza/experiments/sparse_results_12.09/$benchmark/quant_scheme2/$filename.txt