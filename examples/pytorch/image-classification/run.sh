...
M=4
   ...
   then
      ...
      filename=$sparsity_num_format\_block\_size\_$blocksize/hbfp\_$N:$M\_inter/$benchmark\_bfp$mantbits\_sparse\_$blocksize
      mkdir ./sparse_results/$benchmark/sparsity_scheme4/$sparsity_num_format\_block\_size\_$blocksize/
      mkdir ./sparse_results/$benchmark/sparsity_scheme4/$sparsity_num_format\_block\_size\_$blocksize/hbfp\_$N:$M\_inter/
   fi
