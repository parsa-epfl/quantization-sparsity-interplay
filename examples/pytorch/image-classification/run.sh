...
if [ $sparsify == True ]; then
	...
	model="/scratch/new_ayan/checkpoints/vit-$benchmark/fp32_dense"
	suffix="$epochs"
fi

filename=vit\_tensors\_$sparsity_num_format\_$mantbits\_$blocksize/$suffix
logfile=vit\_tensors\_$benchmark\_log\_$sparsity_num_format\_$mantbits\_$blocksize\_$suffix.txt
