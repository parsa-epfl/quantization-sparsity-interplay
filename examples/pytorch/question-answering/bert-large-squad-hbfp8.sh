...
bit_range="[]"
   ...
   then
      ...
      mkdir /home/parsa_liza/experiments/bert_large_squad_hbfp8_sparse/$benchmark/quant_scheme2/$sparsity_num_format\_block\_size\_$blocksize/
      mkdir /home/parsa_liza/experiments/bert_large_squad_hbfp8_sparse/$benchmark/quant_scheme2/$sparsity_num_format\_block\_size\_$blocksize/hbfp\_$bit_range/
   fi
...
CUDA_VISIBLE_DEVICES=0 python run_qa.py \
    ...
    --max_seq_length 384 \
    --doc_stride 128 \
    --output_dir /home/parsa_liza/experiments/bert_large_squad_hbfp8_sparse/$benchmark/quant_scheme2/$filename  \
