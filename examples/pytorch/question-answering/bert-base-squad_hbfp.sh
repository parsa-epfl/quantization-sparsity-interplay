...
bit_range="[]"
   ...
   then
      ...
      mkdir /parsadata1/lisa/experiments/bert-sparse-squad-0.65-hbfp6-eval/$benchmark/quant_scheme2/$sparsity_num_format\_block\_size\_$blocksize/
      mkdir /parsadata1/lisa/experiments/bert-sparse-squad-0.65-hbfp6-eval/$benchmark/quant_scheme2/$sparsity_num_format\_block\_size\_$blocksize/hbfp\_$bit_range/
   fi
...
python3 run_qa.py \
    --model_name_or_path /parsadata1/lisa/experiments/bert-sparse-squad-0.65-unstr/quant_scheme2/fp32/fp32_[2]:[4]/checkpoint-2000 \
    --dataset_name squad \
    --do_eval \
    ...
    --max_seq_length 384 \
    --doc_stride 128 \
    --output_dir /parsadata1/lisa/experiments/bert-sparse-squad-0.65-hbfp6-eval/$benchmark/quant_scheme2/$filename  \
