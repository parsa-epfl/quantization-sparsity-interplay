...
bit_range="[]"
   ...
   then
      ...
      mkdir /home/parsa_liza/experiments/bert_3ep_16_10_7:8_exc/$benchmark/quant_scheme2/$sparsity_num_format\_block\_size\_$blocksize/
      mkdir /home/parsa_liza/experiments/bert_3ep_16_10_7:8_exc/$benchmark/quant_scheme2/$sparsity_num_format\_block\_size\_$blocksize/hbfp\_$bit_range/
   fi
...
CUDA_VISIBLE_DEVICES=1 python run_mlm.py \
    ...
    --output_dir /home/parsa_liza/experiments/bert_3ep_16_10_7:8_exc/$benchmark/quant_scheme2/$filename  \
