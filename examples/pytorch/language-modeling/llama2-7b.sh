...
bit_range="[]"
   ...
   then
      ...
      mkdir /scratch/kostenok/experiments/llama-finetune/2:4-sunday/
   fi
...
CUDA_VISIBLE_DEVICES=0,1 python3 run_llama.py \
    ...
    --output_dir /scratch/kostenok/experiments/llama-finetune/2:4-sunday/ \
