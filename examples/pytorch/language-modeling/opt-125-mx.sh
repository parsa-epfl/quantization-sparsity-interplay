...
bit_range="[]"
   ...
   then
      ...
      mkdir /parsadata1/lisa/experiments/mx_formats/6.7b/mxfp6_unstr_init/$sparsity_num_format\_block\_size\_$blocksize/
      mkdir /parsadata1/lisa/experiments/mx_formats/6.7b/mxfp6_unstr_init/$benchmark/quant_scheme2/$sparsity_num_format\_block\_size\_$blocksize/hbfp\_$bit_range/
   fi
   ...
   device: 'cpu'" >> /usr/local/lib/python3.8/dist-packages/transformers/bfp/bfp_config.yaml
      cd ../../../
   else
...
python3 run_opt.py \
    ...
    --do_eval \
    --output_dir /parsadata1/lisa/experiments/mx_formats/6.7b/mxfp6_unstr_init/$benchmark/quant_scheme2/$filename \
